...
#| tbl-cap: "Summary of commune and village matchings"
...
matching_tbl <- correspondence_table3 %>%
  mutate(method = case_when(
    ...
    method_village = case_when(
      method_village == "method_5" ~ "Matched",
      is.na(method_village) ~ "Unmatched")) 


# Construct a two-way table
tbl_cross(data = matching_tbl,
          row = method,
          col = method_village,
          percent = "cell",
          label = list(method ~ "Matched communes",
                       method_village ~ "Village matched with Fokontany"))
